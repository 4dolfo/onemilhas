(function () {
  "use strict";
  angular
    .module("app.saleClientArquivo", [
      "angularFileUpload",
      "ui.mask",
      "ui.select",
    ])
    .controller("ClientArquivoCtrl", [
      "$scope",
      "$rootScope",
      "$filter",
      "$modal",
      ...
      function (
        ...
        $scope.saveClient = function () {
          ...
          if ($scope.selected.partnerData) {
            if (
              $scope.selected.partnerData._birthDate !== "" &&
              $scope.selected.partnerData._birthDate != "Invalid Date"
            ) {
              $scope.selected.partnerData.birthDate = $rootScope.formatServerDate(
                $scope.selected.partnerData._birthDate
              );
            }
          }
        ...
        $scope.loadClient = function () {
          ...
          cfpLoadingBar.start();
          $.post(
            "../backend/application/index.php?rota=/loadClientArquivo",
            {
